...
public class Ition extends javax.swing.JApplet implements javax.sound.midi.MetaEventListener
{
  ...
  public Ition()
  {
    label_.setFont(new java.awt.Font("SansSerif", java.awt.Font.BOLD, 32)); // Set the font of the label
    getContentPane().add(label_); // Add the label to the applet's content pane
  }
  /**
   * label_
   */
  ...
  /**
   * Timer for updating label
   */
  private final javax.swing.Timer labelleur_ = new javax.swing.Timer(1000, new java.awt.event.ActionListener()
  {
    public void actionPerformed(final java.awt.event.ActionEvent e)
    {
      // On every tick (1 second), update the label with random characters
      char c1 = (char)('A' + Utiles.random(26)); // Choose a random letter
      // Decide the second character (based on whether the first is a vowel)
      char c2 = "AEIOU".indexOf(c1) >= 0 ? "abcdefghijklmn".charAt(Utiles.random(16)) : "cashrd".charAt(Utiles.random(5)); //somethind - it could be cooler
